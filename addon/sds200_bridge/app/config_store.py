...
def normalize(raw: dict) -> dict:
    ...
    return {
        ...
        "transcribe": {
            ...
            # How much audio stays on disk: a count, a size and an age, 0
            # for "no limit of this kind", and a clip goes when any of them
            # says so. Whatever they say, a clip never outlives its row.
            # See the notes at transcribe.DEFAULT_KEEP_CLIPS.
            "keep_clips": _int(
                transcribe_cfg.get("keep_clips"),
                transcribe.DEFAULT_KEEP_CLIPS, 0, transcribe.MAX_KEEP_CLIPS,
            ),
            "keep_clips_mb": _int(
                transcribe_cfg.get("keep_clips_mb"),
                transcribe.DEFAULT_KEEP_CLIPS_MB, 0, transcribe.MAX_KEEP_CLIPS_MB,
            ),
            "keep_clips_days": _int(
                transcribe_cfg.get("keep_clips_days"),
                transcribe.DEFAULT_KEEP_CLIPS_DAYS, 0, transcribe.MAX_KEEP_CLIPS_DAYS,
            ),
        },
