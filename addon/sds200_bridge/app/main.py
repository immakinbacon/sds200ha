...
async def main() -> None:
    ...
    # A clip never outlives its row: the history hands over the names of
    # the clips on the rows it prunes, and of those past their own age
    # limit. See ReceiveHistory.prune.
    history.clip_reaper = transcriber.discard_clips
